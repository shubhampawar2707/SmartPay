...
<div class="page-wrapper">
                            ...
                            <div class="table-wrapper">
                                <table id="job-details-table" class="table">
                                    ...
                                    <tr>
                                        ...
                                        <td id="basic" value="10000">${user.salary*2/5}</td>
                                    </tr>
                                    <tr>
                                        <td class="job-title">HRA</td>
                                        <td id="hra">${user.salary*1/5}</td> 
                                    </tr>
                                    <tr>
                                        <td class="job-title">Conveyance</td>
                                        <td id="da">${user.salary/10}</td> 
                                    </tr>
                                    <tr>
                                        <td class="job-title">Medical Allowance</td>
                                        <td id="ta">${user.salary*0.05}</td> 
                                    </tr>
                                    <tr>
    ...
    <footer class="site-footer">
        ...
        <div class="bottom-footer">
            <div class="container">
                <p>&copy; Copyright <script>document.write(new Date().getFullYear())</script> by <a href="" target="_blank">Shubham Pawar</a></p>
            </div><!-- /.container -->
        </div><!-- /.bottom-footer -->
    </footer><!-- /.site-footer -->
...
<script src="js/smtp.js"></script>
									    ...
									    var message = "Hii  "+name+",\n"+"your PaySlip for the month of "+month+" is "+result+"\n For details contact branch office.\nThank you.";
											function sendEmail() {
												Email.send({
													Host: "smtp.gmail.com",
													Username : "shubhupawar1107@gmail.com",
													Password : "Shubham@1107",
													To : email,
													From : "shubhupawar1107@gmail.com",
													Subject : "Pay Slip",
													Body : message,
												})
